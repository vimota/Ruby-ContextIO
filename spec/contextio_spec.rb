...
describe ContextIO::Connection do
  ...
  it "should call addresses.json" do
    ...
    files = @connection.addresses(:account => @account)
  end

  it "should call allfiles.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/allfiles.json?since=#{@five_days_ago}&account=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call allmessage.json" do
    ...
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/allmessages.json?limit=1&since=#{@five_days_ago}&account=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call reflect limit" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/allmessages.json?limit=10&since=#{@five_days_ago}&account=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
    @connection.all_messages(:account => @account, :limit => 10, :since => @five_days_ago)
  end

  it "should call contactsearch.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/contactsearch.json?account=#{@account}&search=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
    @connection.contact_search(:account => @account, :search => @account)
  end

  it "should call contactfiles.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/contactfiles.json?account=#{@account}&email=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call contactmessages.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/contactmessages.json?account=#{@account}&email=#{@account}&cc=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should allow multile emails" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/contactmessages.json?account=#{@account}&email=#{@account},#{@account}&cc=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call diffsummary.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/diffsummary.json?account=#{@account}&fileid1=1&fileid2=2&generate=1", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call filesearch.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/filesearch.json?account=#{@account}&filename=proposal", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call messageinfo.json" do
    ...
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/messageinfo.json?account=#{@account}&emailmessageid=#{message_id}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should allow date sent and from as options" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/messageinfo.json?account=#{@account}&datesent=#{@five_days_ago}&from=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call messagetext.json" do
    message_id = "1234567890"
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/messagetext.json?account=#{@account}&emailmessageid=#{message_id}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should allow date sent and from as parameters" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/messagetext.json?account=#{@account}&datesent=#{@five_days_ago}&from=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call relatedfiles.json" do
    file_id = "1234567890"
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/relatedfiles.json?account=#{@account}&fileid=#{file_id}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should allow file_name as a parameter" do
    file_name = "proposal"
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/relatedfiles.json?account=#{@account}&filename=#{file_name}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call threadinfo.json with proper params" do
    ...
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/threadinfo.json?account=#{@account}&gmailthreadid=#{gmail_thread_id}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call discover with proper params" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/discover.json?email=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
    @connection.discover(:email => @account)
  end

  it "should call imap/accountinfo.json with proper params" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/accountinfo.json?email=#{@account}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
    @connection.account_info(:email => @account)
  end

  it "should call imap/oauthproviders.json" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/oauthproviders.json", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call proper url for add account" do
    ...
    port     = 993
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/addaccount.json?email=#{@account}&server=#{server}&username=#{username}&password=#{password}&usessl=1&port=#{port}", 
  ...
  it "should call proper url for modify account" do
    ...
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/modifyaccount.json?credentials=#{credentials}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call proper url for remove account" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/removeaccount.json", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should call proper url for reset status" do
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/imap/resetstatus.json", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
  ...
  it "should download file" do
    ...
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/downloadfile?fileid=#{file_id}")
  ...
  it "should search with regular expressions" do
    subject = "api"
    OAuth::AccessToken.any_instance.expects(:get).once
          .with("/1.1/search.json?account=#{@account}&subject=#{subject}", "Accept" => "application/json")
          .returns(stub(:body => '{"data": {}}'))
